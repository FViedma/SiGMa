...
<div class="row">
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            <div class="card-header card-header-warning card-header-icon">
                ...
                <a href="mantenimiento.php" class="card-category text-warning font-weight-bold">
                    MTTO EQUIPO MEDICO
                </a>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header card-header-primary">
                <h3 class="title-2 m-b-40">MANTENIMIENTOS REALIZADOS</h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header card-header-primary">
                <h3 class="title-2 m-b-40">MANTENIMIENTOS PENDIENTES</h3>
            </div>
            <div class="card-body">
