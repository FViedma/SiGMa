                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            <a href="#" onclick="editarTipo(<?php echo $data['id_servicio']; ?>)" class="btn btn-primary"><i class='fas fa-edit'></i></a>
                                            <form action="eliminar_tipo.php?id=<?php echo $data['id_servicio']; ?>" method="post" class="confirmar d-inline">
