...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="blue" data-image="../assets/img/">
            <div class="logo bg-primary"><a href="../assets/img/uno.ico" class="simple-text logo-normal">
            <div class="card-icon">
            <a href="../assets/img/logovied.png">
                </div>
            SIG-MA
                </a></div>
